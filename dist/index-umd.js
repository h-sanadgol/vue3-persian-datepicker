(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : typeof define === 'function' && define.amd
      ...
      : ((global =
        ...
        factory((global.DatePicker = {}), global.Vue));
  ...
  var PersianDate_min = createCommonjsModule(function (module) {
    ...
    function quarter(t) {
      ...
      var e = Math.ceil(
        ('gregorian' == this.c ? this.d.month : this.toDate().getMonth() + 1) /
          3,
      );
      return 'Q' == t
        ? e
    ...
    function timestamp(t) {
      return t
        ? this.fromGregorian(+String(t).trim())
        : this.toDate().getTime();
    }
    ...
    function fromJalali() {
      ...
      return (
        ...
        'jalali' == this.c
          ...
          : setGregorianDate.call(
              this,
              jtg.apply(void 0, _toConsumableArray(r)),
            ),
        ...
        return __props.name.endsWith('[]')
          ? (vue.openBlock(true),
            vue.createElementBlock(
              vue.Fragment,
              { key: 0 },
              vue.renderList(__props.dates, (date, i) => {
                return (
                  vue.openBlock(),
                  vue.createElementBlock(
                    'input',
          ...
          : (vue.openBlock(),
            vue.createElementBlock(
              'input',
              {
                ...
                type: 'hidden',
                name: __props.name,
                value: __props.dates.map((date) =>
                  date.toString(__props.format),
                ),
              },
              null,
              8 /* PROPS */,
    ...
    return (
      ...
      vue.createElementBlock(
        ...
        [
          ...
          vue.createElementVNode(
            'div',
            vue.normalizeProps(vue.guardReactiveProps(_ctx.attrs.div)),
            [
              (vue.openBlock(true),
              vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList(_ctx.inputs, (input, index) => {
                  return (
                    vue.openBlock(),
                    vue.createElementBlock(
                      vue.Fragment,
          ...
          _ctx.showDatePicker
            ? (vue.openBlock(),
              vue.createElementBlock('div', _hoisted_5, [
                ...
                vue.createElementVNode(
                  'div',
                  vue.mergeProps(_ctx.attrs.picker, { ref: 'pdpPicker' }),
                  [
                    vue.createElementVNode('div', _hoisted_6, [
                                      ...
                                      (month, index) => {
                                        return (
                                          ...
                                          vue.createElementBlock(
                                            ...
                                            vue.toDisplayString(month.label),
                                            11 /* TEXT, CLASS, PROPS */,
                                            _hoisted_9,
                                          )
                                        );
                      ...
                      _ctx.type.includes('date')
                        ? (vue.openBlock(),
                          vue.createElementBlock('div', _hoisted_12, [
                            _ctx.locale.includes(',')
                              ? (vue.openBlock(),
                                vue.createElementBlock('div', _hoisted_13, [
                                  vue.createElementVNode(
                                    'div',
                                    null,
                                    vue.toDisplayString(
                                      _ctx.lang.translations.text,
                                    ),
                                    1 /* TEXT */,
                                  ),
                                  vue.createElementVNode(
                                    ...
                                    vue.toDisplayString(_ctx.nextLocale),
                                    9 /* TEXT, PROPS */,
                                    _hoisted_14,
                                  ),
                                ]))
                      ...
                      vue.createElementVNode(
                        ...
                        [
                          _ctx.type.includes('date')
                            ? (vue.openBlock(),
                              vue.createElementBlock('div', _hoisted_19, [
                                (vue.openBlock(true),
                                vue.createElementBlock(
                                  vue.Fragment,
                                  null,
                          ...
                          _ctx.type.includes('time')
                            ? (vue.openBlock(),
                              vue.createElementBlock('div', _hoisted_24, [
                                _ctx.type == 'time'
                                  ? (vue.openBlock(),
                                    vue.createElementBlock('div', _hoisted_25, [
                                      (vue.openBlock(true),
                                      vue.createElementBlock(
                                        vue.Fragment,
                                        null,
                          ...
                          _ctx.checkDate(_ctx.core, 'date')
                            ? (vue.openBlock(),
                              vue.createElementBlock(
                                ...
                                vue.toDisplayString(_ctx.lang.translations.now),
                                9 /* TEXT, PROPS */,
                                _hoisted_35,
                              ))
                            : vue.createCommentVNode('v-if', true),
                    ...
                    _ctx.shortcuts && Object.keys(_ctx.shortcuts).length > 0
                      ? (vue.openBlock(),
                        vue.createElementBlock('ul', _hoisted_37, [
                          (vue.openBlock(true),
                          vue.createElementBlock(
                            vue.Fragment,
                            null,
                            vue.renderList(_ctx.shortcuts, (dates, name) => {
                              return (
                                vue.openBlock(),
                                vue.createElementBlock(
                                  'li',
